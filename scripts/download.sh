...
wget ${DOWNLOADLINK}/scripts/setup-hana.sh --output-document=/root/install/setup-hana.sh
wget ${DOWNLOADLINK}/scripts/rc_local_master.sh --output-document=/root/install/rc_local_master.sh
wget ${DOWNLOADLINK}/scripts/rc_local_worker.sh --output-document=/root/install/rc_local_worker.sh
